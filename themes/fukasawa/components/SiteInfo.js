...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            ...
            <br />
            <span className='text-xs font-serif'> Thanks to <a href='https://github.com/tangly1024/NotionNext' className='underline text-gray-500 dark:text-gray-300'>NotionNext {BLOG.VERSION}</a></span><br /></span>
            <h1>{title}</h1>
        </footer>
  )
}
