  ...
  return (
    ...
    >
      ...
      <span>
        ...
        <br />
        <h1>{title}</h1>
        <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '>Thanks for  <a href='https://github.com/tangly1024/NotionNext' className='underline '>NotionNext {BLOG.VERSION}</a>.</span>
      </span>
    </footer>
  )
}
